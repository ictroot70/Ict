...
import { InfoPage, Typography } from '@/shared/ui'
  ...
  return (
    <>
      ...
      <Typography variant="regular_14">
        ...
        lobortis mattis aliquam. Quam adipiscing vitae proin sagittis nisl rhoncus mattis rhoncus.
...
export default function PrivacyPolicy() {
  return (
    <InfoPage title="Privacy Policy" backButtonText="Back to Sign Up" link={APP_ROUTES.AUTH.REGISTRATION}> 
